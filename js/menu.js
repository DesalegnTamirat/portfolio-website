...
(function () {
    ...
    desktop_elements[i].addEventListener("click", function () {
      if (!this.classList.contains("active")) {
        if (document.body.classList.contains("animation-top")) {
          ...
          document.body.classList.contains("animation-cornertopleft")
        ) {
          reveal("cornertopleft");
        } else if (
          document.body.classList.contains("animation-cornertopright")
        ) {
          reveal("cornertopright");
        } else if (
          document.body.classList.contains("animation-cornerbottomleft")
        ) {
          reveal("cornerbottomleft");
        } else if (
          document.body.classList.contains("animation-cornerbottomright")
        ) {
  ...
  link_about.addEventListener("click", function () {
    ...
    var desktop_nav_elements = document.querySelectorAll(
      ".desktop-nav-element"
    );
    setTimeout(function () {
      document.body.classList.remove("home-page");
